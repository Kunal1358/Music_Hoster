...
public class MusicHosterApplication {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("MusicHoster API")
				.description("MusicHoster API for developers").termsOfServiceUrl("https://simplifyingtech371899608.wordpress.com/").licenseUrl("t9814312194@gmail.com").version("2.0").build();
	}
